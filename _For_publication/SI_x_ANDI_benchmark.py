...
methodJ_pred_2D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodJ_{}D_temporal_pred.pkl'.format(2), 'rb'))
methodJ_true_2D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodJ_{}D_ensemble_temporal_true.pkl'.format(2), 'rb'))
print('J', np.mean(np.hstack(methodJ_true_2D)==np.hstack(methodJ_pred_2D)))

methodE_pred_2D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodE_{}D_temporal_pred.pkl'.format(2), 'rb'))
methodE_true_2D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodE_{}D_ensemble_temporal_true.pkl'.format(2), 'rb'))
print('E', np.mean(np.hstack(methodE_true_2D)==np.hstack(methodE_pred_2D)))

methodE_pred_3D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodE_{}D_temporal_pred.pkl'.format(3), 'rb'))
methodE_true_3D = pickle.load(open('../Andi_Challenge_Code/analytics/MethodE_{}D_ensemble_temporal_true.pkl'.format(3), 'rb'))
print('E', np.mean(np.hstack(methodE_true_3D)==np.hstack(methodE_pred_3D)))

DeepSPT_pred_2D = pickle.load(open('../Andi_Challenge_Code/analytics/ANDIdeepspt_{}D_temporal_pred.pkl'.format(2), 'rb'))
DeepSPT_true_2D = pickle.load(open('../Andi_Challenge_Code/analytics/ANDIdeepspt_{}D_ensemble_temporal_true.pkl'.format(2), 'rb'))
print('DeepSPT', np.mean(np.hstack(DeepSPT_true_2D)==np.hstack(DeepSPT_pred_2D)))

DeepSPT_pred_3D = pickle.load(open('../Andi_Challenge_Code/analytics/ANDIdeepspt_{}D_temporal_pred.pkl'.format(3), 'rb'))
DeepSPT_true_3D = pickle.load(open('../Andi_Challenge_Code/analytics/ANDIdeepspt_{}D_ensemble_temporal_true.pkl'.format(3), 'rb'))
print('DeepSPT', np.mean(np.hstack(DeepSPT_true_3D)==np.hstack(DeepSPT_pred_3D)))


# assert all true are equal
print(np.mean(np.hstack(methodJ_true_2D)==np.hstack(methodE_true_2D)))
print(np.mean(np.hstack(methodJ_true_2D)==np.hstack(DeepSPT_true_2D)))
print()
