...
filename_X = '/Users/jacobkh/Documents/PhD/SPT/github_final/DeepSPT/deepspt_results/analytics/endosomal_tracks_EEA1NPC1.pkl'
fid=py.open(filename_X,'rb');
uncoat_tracks=py.pickle.load(fid);

test_y_path = 'analytics/AP2_FPy_DeepSPT.pkl'
...
for c = 1:100
    ...
    filePath = append('/Users/jacobkh/Documents/PhD/SPT/github_final/DeepSPT/_For_publication/baseline_methods/HMM_rota/analysis_endo_',string(c));
    if exist(filePath, 'file') == 2
        % If the file exists, skip to the next iteration of the loop
        disp(['File exists, skipping to next iteration for: ', filePath]);
        continue;
    end
    ...
    save(append('/Users/jacobkh/Documents/PhD/SPT/github_final/DeepSPT/_For_publication/baseline_methods/HMM_rota/analysis_endo_',string(c)),'cfg','results')
    save(append('/Users/jacobkh/Documents/PhD/SPT/github_final/DeepSPT/_For_publication/baseline_methods/HMM_rota/analysis_endo_samples',string(c)),'cfg','results','full_fitting')
